...
$(document).ready(function() {
	...
	$('#certiLoginBtn').click(function(){
		$('#userLoginLabel').html('用户注册');
		$('#FormforLoginBtn').hide();
		$('#checkrememberUserBox').hide();
		$('#FormforLoginBtn1').show();
		$('#pwdInputFrame1').show();
	})

	$('#FormforLoginBtn1').click(function(){
		$('#userLoginLabel').html('用户登录');
		$('#FormforLoginBtn').show();
		$('#checkrememberUserBox').show();
		$('#FormforLoginBtn1').hide();
		$('#pwdInputFrame1').hide();
	})
});
